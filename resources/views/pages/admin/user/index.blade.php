                            ...
                            <form action="{{ route('user.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input name="password" type="password" value="rahasia" hidden>
                                        <div class="form-group">
...
<script>
    $(document).ready(function() {
        $('#roles').change(function() {
            ...
            if (kel == "dosen") {
                $("#noId").html('<label for="nip">NIP dosen</label><input id="nip" type="text" onkeypress="return inputAngka(event)" placeholder="NIP dosen" class="form-control" name="nip" autocomplete="off">');
            } else if (kel == "siswa") {
                $("#noId").html(`<label for="npm">npm Siswa</label><input id="npm" type="text" placeholder="npm Siswa" class="form-control" name="npm" autocomplete="off">`);
            } else if (kel == "admin") {
